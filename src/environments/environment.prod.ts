...
export const environment = {
  ...
  addCustomerRegistration:BASE_URL + "customerRegister/saveRegisterCustomer",
  getProductCodeList:BASE_URL + "productTypeSetting/getProductCodeList",
  getProductCodeDescriptiondetails:BASE_URL + "productTypeSetting/getProductCodeList",
  ...
  binNumber:/^\d{6}$/,
  binDescription:/^[a-zA-Z0-9\s,'-]*$/,
  alphaNumAt: /^[a-zA-Z0-9@]*$/,
  alphanumericvalid6: /^.*(?=.{6,})[a-zA-Z0-9]+$/,
  threeNumber: /^\d{3}$/,
  // alphaNumAt: /^[a-zA-Z0-9@]*$/,
  onlyNumber:/^[0-9]*$/,
  onlyPercentage:/^[1-9]?[0-9]{1}$|^100$/
};
